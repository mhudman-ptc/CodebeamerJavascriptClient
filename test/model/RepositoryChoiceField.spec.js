...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RepositoryChoiceField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.RepositoryChoiceField();
      });

      it('should create an instance of RepositoryChoiceField', function() {
        // TODO: update the code to test RepositoryChoiceField
        expect(instance).to.be.a(CodebeamerSwaggerApi.RepositoryChoiceField);
      });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodebeamerSwaggerApi.GroupApi();
  });
    ...
    describe('GroupApi', function() {
      describe('getGroup', function() {
        it('should call getGroup successfully', function(done) {
          ...
          instance.getGroup(groupId, function(error, data, response) {
            ...
            expect(data).to.be.a(CodebeamerSwaggerApi.UserGroup);
      ...
      describe('getGroups', function() {
        it('should call getGroups successfully', function(done) {
          // TODO: uncomment getGroups call and complete the assertions
          /*

          instance.getGroups(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(CodebeamerSwaggerApi.UserGroupReference);
            }

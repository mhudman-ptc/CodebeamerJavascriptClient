...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReportReference', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.ReportReference();
      });

      it('should create an instance of ReportReference', function() {
        // TODO: update the code to test ReportReference
        expect(instance).to.be.a(CodebeamerSwaggerApi.ReportReference);
      });

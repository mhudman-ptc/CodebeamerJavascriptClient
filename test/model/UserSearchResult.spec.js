...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.UserSearchResult();
      });

      it('should create an instance of UserSearchResult', function() {
        // TODO: update the code to test UserSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.UserSearchResult);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrackerItemSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.TrackerItemSearchResult();
      });

      it('should create an instance of TrackerItemSearchResult', function() {
        // TODO: update the code to test TrackerItemSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.TrackerItemSearchResult);
      });

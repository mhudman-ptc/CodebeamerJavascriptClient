...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OptionChoiceField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.OptionChoiceField();
      });

      it('should create an instance of OptionChoiceField', function() {
        // TODO: update the code to test OptionChoiceField
        expect(instance).to.be.a(CodebeamerSwaggerApi.OptionChoiceField);
      });

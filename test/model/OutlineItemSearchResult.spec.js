...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OutlineItemSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.OutlineItemSearchResult();
      });

      it('should create an instance of OutlineItemSearchResult', function() {
        // TODO: update the code to test OutlineItemSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.OutlineItemSearchResult);
      });

      it('should have the property outlineItems (base name: "outlineItems")', function() {
        // TODO: update the code to test the property outlineItems
        expect(instance).to.have.property('outlineItems');
        // expect(instance.outlineItems).to.be(expectedValueLiteral);
      });

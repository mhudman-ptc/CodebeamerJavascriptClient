...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WorkingSetItemMapping', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.WorkingSetItemMapping();
      });

      it('should create an instance of WorkingSetItemMapping', function() {
        // TODO: update the code to test WorkingSetItemMapping
        expect(instance).to.be.a(CodebeamerSwaggerApi.WorkingSetItemMapping);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrackerItemChoiceField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.TrackerItemChoiceField();
      });

      it('should create an instance of TrackerItemChoiceField', function() {
        // TODO: update the code to test TrackerItemChoiceField
        expect(instance).to.be.a(CodebeamerSwaggerApi.TrackerItemChoiceField);
      });

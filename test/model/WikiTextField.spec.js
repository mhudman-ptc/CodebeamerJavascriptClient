...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WikiTextField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.WikiTextField();
      });

      it('should create an instance of WikiTextField', function() {
        // TODO: update the code to test WikiTextField
        expect(instance).to.be.a(CodebeamerSwaggerApi.WikiTextField);
      });

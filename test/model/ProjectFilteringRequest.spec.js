...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectFilteringRequest', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.ProjectFilteringRequest();
      });

      it('should create an instance of ProjectFilteringRequest', function() {
        // TODO: update the code to test ProjectFilteringRequest
        expect(instance).to.be.a(CodebeamerSwaggerApi.ProjectFilteringRequest);
      });

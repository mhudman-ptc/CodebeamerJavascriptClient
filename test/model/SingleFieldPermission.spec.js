...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SingleFieldPermission', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.SingleFieldPermission();
      });

      it('should create an instance of SingleFieldPermission', function() {
        // TODO: update the code to test SingleFieldPermission
        expect(instance).to.be.a(CodebeamerSwaggerApi.SingleFieldPermission);
      });

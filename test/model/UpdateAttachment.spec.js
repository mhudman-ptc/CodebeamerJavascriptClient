...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateAttachment', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.UpdateAttachment();
      });

      it('should create an instance of UpdateAttachment', function() {
        // TODO: update the code to test UpdateAttachment
        expect(instance).to.be.a(CodebeamerSwaggerApi.UpdateAttachment);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrackerItemHistory', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.TrackerItemHistory();
      });

      it('should create an instance of TrackerItemHistory', function() {
        // TODO: update the code to test TrackerItemHistory
        expect(instance).to.be.a(CodebeamerSwaggerApi.TrackerItemHistory);
      });

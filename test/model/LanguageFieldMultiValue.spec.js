...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LanguageFieldMultiValue', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.LanguageFieldMultiValue();
      });

      it('should create an instance of LanguageFieldMultiValue', function() {
        // TODO: update the code to test LanguageFieldMultiValue
        expect(instance).to.be.a(CodebeamerSwaggerApi.LanguageFieldMultiValue);
      });

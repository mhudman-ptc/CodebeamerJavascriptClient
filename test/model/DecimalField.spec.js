...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DecimalField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.DecimalField();
      });

      it('should create an instance of DecimalField', function() {
        // TODO: update the code to test DecimalField
        expect(instance).to.be.a(CodebeamerSwaggerApi.DecimalField);
      });

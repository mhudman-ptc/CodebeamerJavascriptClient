...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReferenceSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.ReferenceSearchResult();
      });

      it('should create an instance of ReferenceSearchResult', function() {
        // TODO: update the code to test ReferenceSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.ReferenceSearchResult);
      });

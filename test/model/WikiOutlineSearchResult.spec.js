...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WikiOutlineSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.WikiOutlineSearchResult();
      });

      it('should create an instance of WikiOutlineSearchResult', function() {
        // TODO: update the code to test WikiOutlineSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.WikiOutlineSearchResult);
      });

      it('should have the property outlineWikiPages (base name: "outlineWikiPages")', function() {
        // TODO: update the code to test the property outlineWikiPages
        expect(instance).to.have.property('outlineWikiPages');
        // expect(instance.outlineWikiPages).to.be(expectedValueLiteral);
      });

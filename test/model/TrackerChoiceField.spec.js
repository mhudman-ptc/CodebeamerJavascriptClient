...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrackerChoiceField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.TrackerChoiceField();
      });

      it('should create an instance of TrackerChoiceField', function() {
        // TODO: update the code to test TrackerChoiceField
        expect(instance).to.be.a(CodebeamerSwaggerApi.TrackerChoiceField);
      });

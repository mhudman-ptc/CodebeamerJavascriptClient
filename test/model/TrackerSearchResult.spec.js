...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrackerSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.TrackerSearchResult();
      });

      it('should create an instance of TrackerSearchResult', function() {
        // TODO: update the code to test TrackerSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.TrackerSearchResult);
      });

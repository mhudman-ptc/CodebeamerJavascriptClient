...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CountryFieldMultiValue', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.CountryFieldMultiValue();
      });

      it('should create an instance of CountryFieldMultiValue', function() {
        // TODO: update the code to test CountryFieldMultiValue
        expect(instance).to.be.a(CodebeamerSwaggerApi.CountryFieldMultiValue);
      });

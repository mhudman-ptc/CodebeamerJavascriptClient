...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectChoiceField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.ProjectChoiceField();
      });

      it('should create an instance of ProjectChoiceField', function() {
        // TODO: update the code to test ProjectChoiceField
        expect(instance).to.be.a(CodebeamerSwaggerApi.ProjectChoiceField);
      });

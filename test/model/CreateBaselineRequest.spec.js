...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateBaselineRequest', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.CreateBaselineRequest();
      });

      it('should create an instance of CreateBaselineRequest', function() {
        // TODO: update the code to test CreateBaselineRequest
        expect(instance).to.be.a(CodebeamerSwaggerApi.CreateBaselineRequest);
      });

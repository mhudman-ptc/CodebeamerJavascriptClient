...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DurationField', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.DurationField();
      });

      it('should create an instance of DurationField', function() {
        // TODO: update the code to test DurationField
        expect(instance).to.be.a(CodebeamerSwaggerApi.DurationField);
      });

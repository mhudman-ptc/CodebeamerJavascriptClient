...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DefaultMultiFieldValue', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.DefaultMultiFieldValue();
      });

      it('should create an instance of DefaultMultiFieldValue', function() {
        // TODO: update the code to test DefaultMultiFieldValue
        expect(instance).to.be.a(CodebeamerSwaggerApi.DefaultMultiFieldValue);
      });

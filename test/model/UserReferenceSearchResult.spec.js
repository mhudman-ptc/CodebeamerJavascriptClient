...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserReferenceSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.UserReferenceSearchResult();
      });

      it('should create an instance of UserReferenceSearchResult', function() {
        // TODO: update the code to test UserReferenceSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.UserReferenceSearchResult);
      });

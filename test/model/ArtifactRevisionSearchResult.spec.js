...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ArtifactRevisionSearchResult', function() {
      beforeEach(function() {
        instance = new CodebeamerSwaggerApi.ArtifactRevisionSearchResult();
      });

      it('should create an instance of ArtifactRevisionSearchResult', function() {
        // TODO: update the code to test ArtifactRevisionSearchResult
        expect(instance).to.be.a(CodebeamerSwaggerApi.ArtifactRevisionSearchResult);
      });
      ...
      it('should have the property revisions (base name: "revisions")', function() {
        // TODO: update the code to test the property revisions
        expect(instance).to.have.property('revisions');
        // expect(instance.revisions).to.be(expectedValueLiteral);
      });
